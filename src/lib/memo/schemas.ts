...
//
// Note: there is deliberately NO position-size field in the synthesis schema —
// sizing is computed deterministically by src/lib/sizing/engine.ts, and the
// LLM only interprets it.
import { z } from "zod";
